...
let s:p.normal.right = [ [ '#292c33', '#98c379', s:term_black, s:term_green ], [ '#98c379', '#3e4452', s:term_green, s:term_grey ], [ '#abb2bf', '#292c33', s:term_green, s:term_black ] ]
...
let s:p.insert.right = [ [ '#292c33', '#61afef', s:term_black, s:term_blue ], [ '#61afef', '#3E4452', s:term_blue, s:term_grey ], [ '#abb2bf', '#292c33', s:term_blue, s:term_black ] ]
let s:p.replace.left = [ [ '#292c33', '#e06c75', s:term_black, s:term_red, 'bold' ], [ '#e06c75', '#292c33', s:term_red, s:term_black ] ]
let s:p.replace.right = [ [ '#292c33', '#e06c75', s:term_black, s:term_red ], [ '#e06c75', '#3e4452', s:term_red, s:term_grey ], [ '#abb2bf', '#292c33', s:term_grey, s:term_black ] ]
let s:p.visual.left = [ [ '#292c33', '#c678dd', s:term_black, s:term_purple, 'bold' ], [ '#c678dd', '#292c33', s:term_purple, s:term_black ] ]
let s:p.visual.right = [ [ '#292c33', '#c678dd', s:term_black, s:term_purple ], [ '#c678dd', '#3e4452', s:term_purple, s:term_grey ], [ '#abb2bf', '#292c33', s:term_grey, s:term_black ] ]
